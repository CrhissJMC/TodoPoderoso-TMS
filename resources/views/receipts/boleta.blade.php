...
<body>
    ...
    <div class="info-section">
        <div class="info-col">
            <table class="info-table">
                ...
                <tr><td><strong>D.N.I.</strong></td><td>: {{ $ticket->client->document_number }}</td></tr>
        ...
        <table>
            <tr>
                <td width="60%">
                    ...
                    <strong>DNI:</strong> {{ $ticket->client->document_number }}<br>
    ...
    <div class="totals-section">
        ...
        <div class="totals-col">
            <table class="totals-table">
                ...
                <tr><td>Total No Gravado</td><td>: S/</td><td>{{ number_format($ticket->fare, 2) }}</td></tr>
                <tr><td>Total Exonerado</td><td>: S/</td><td>0.00</td></tr>
    ...
    <div class="qr-section">
        <p>Representación impresa de la Boleta Electrónica Autorizado mediante la RS N° 0180050002160 /Sunat</p>
