                                    ...
                                    <td className="px-4 py-3">
                                        <div className="flex items-center justify-end gap-1">
                                            ...
                                            {t.ticket_status !== 'anulado' && (
                                                <>
                                                    <a href={route('receipts.ticket.voucher', t.id)} target="_blank" title="Imprimir Voucher"
                                                    ...
                                                    {t.client?.document_type === 'DNI' && (
                                                        <a href={route('receipts.ticket.boleta', t.id)} target="_blank" title="Imprimir Boleta"
                                                            className="p-1.5 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors font-bold text-[10px]">
                                                            BOL
                                                        </a>
                                                    )}
                                                    {t.client?.document_type === 'RUC' && (
                                                        <a href={route('receipts.ticket.factura', t.id)} target="_blank" title="Imprimir Factura"
                                                            className="p-1.5 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors font-bold text-[10px]">
                                                            FAC
                                                        </a>
                                                    )}
