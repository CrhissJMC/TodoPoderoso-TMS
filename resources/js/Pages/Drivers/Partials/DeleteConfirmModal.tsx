...
interface DeleteConfirmModalProps {
    driver: any; // Usamos 'any' por simplicidad para no requerir la importación
    onClose: () => void;
}

export default function DeleteConfirmModal({ driver, onClose }: DeleteConfirmModalProps) {
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-5">
                ...
                <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">
                        ...
                        Su registro se desactivará pero podrá recuperarse.
                    </p>
                </div>
