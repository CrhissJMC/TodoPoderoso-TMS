...
export default function RoutesIndex({ routes, counts, filters }: Props) {
    ...
    const hasAdmin = permissions.includes('rutas.admin');
                                ...
                                <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-4 py-3">
                                        <button
                                            ...
                                            disabled={!hasAdmin}
                                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ring-1 transition-colors disabled:opacity-75 disabled:cursor-not-allowed ${r.active
