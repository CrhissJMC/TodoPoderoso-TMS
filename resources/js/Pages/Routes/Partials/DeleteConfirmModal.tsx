...
export default function DeleteConfirmModal({ route, onClose }: Props) {
    ...
    function handleDelete() {
        setProcessing(true);
        router.delete(window.route('routes.destroy', route!.id), {
            onSuccess: onClose,
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-5">
                ...
                <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">
                        ¿Confirmas que deseas eliminar la ruta{' '}
                        <span className="font-medium text-gray-700">{route.name}</span>?
                        Se eliminarán también todas sus paradas.
                    </p>
                </div>
