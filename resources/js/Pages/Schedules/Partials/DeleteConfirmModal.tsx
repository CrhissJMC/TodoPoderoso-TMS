...
export default function DeleteConfirmModal({ schedule, onClose }: Props) {
        ...
        >
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-5">
                ...
                <div className="text-center">
                    <h3 className="text-base font-semibold text-gray-900">Eliminar horario</h3>
                    <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">
                        ¿Confirmas eliminar el horario de las{' '}
                        <span className="font-semibold text-gray-700">{schedule.formatted_time}</span>{' '}
                        para la ruta{' '}
                        <span className="font-medium text-gray-700">{schedule.route.name}</span>?
                        Los viajes ya generados no se verán afectados.
                    </p>
                </div>
