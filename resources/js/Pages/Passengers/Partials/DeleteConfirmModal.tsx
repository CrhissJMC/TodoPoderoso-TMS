...
interface Props { passenger: Passenger | null; onClose: () => void; }

export default function DeleteConfirmModal({ passenger, onClose }: Props) {
    ...
    function handleDelete() {
        setProcessing(true);
        router.delete(route('passengers.destroy', passenger!.id), {
            onSuccess: onClose,
        ...
        >
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-5">
                ...
                <div className="text-center">
                    <h3 className="text-base font-semibold text-gray-900">Eliminar pasajero</h3>
                    <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">
                        ¿Confirmas eliminar a{' '}
                        <span className="font-medium text-gray-700">{passenger.full_name}</span>{' '}
                        (DNI: {passenger.dni})? Su historial de boletos se conservará.
                    </p>
                </div>
